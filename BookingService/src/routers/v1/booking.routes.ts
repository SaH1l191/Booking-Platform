...
bookingRouter.get('/availability', requireAuth,validateSchemaQuery(checkAvailabilitySchema), checkAvailabilityHandler); 
//GET /checkAvailability?hotelId=2&roomId=4&checkIn=2026-12-20&checkOut=2026-12-25

bookingRouter.get('/me', requireAuth, getBookingsByUserHandler);
