    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-md mx-auto px-6 py-12 md:py-20">
        ...
        <p className="mt-2 text-gray-600">
          Log in to your StayEase account
        </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="text-sm font-medium text-gray-900 underline hover:text-gray-600">
              Forgot password?
            </button>
          </div>
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link href="/signup" className="font-medium text-gray-900 underline hover:text-gray-600">
            Sign up
          </Link>
        </p>
      </main>
