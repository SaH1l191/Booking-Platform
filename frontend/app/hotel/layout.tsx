        ...
        <div className="px-6 py-5 border-b border-white/10">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="block text-[10px] text-gold uppercase tracking-widest">Hotel Portal</span>
            </div>
          </Link>
        </div>
      ...
      <div className="flex-1 lg:ml-64">
        <div className="lg:hidden sticky top-0 z-40 glass border-b border-border-light px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider text-gold">Hotel Portal</span>
          </div>
