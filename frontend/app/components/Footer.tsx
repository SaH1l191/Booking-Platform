        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li><span className="hover:underline cursor-pointer">Report neighbourhood concern</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li><span className="hover:underline cursor-pointer">StayEase your home</span></li>
              ...
              <li><Link href="/hotels" className="hover:underline">StayEase-friendly apartments</Link></li>
            </ul>
          </div>

          {/* StayEase */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900 mb-4">StayEase</h3>
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li><span className="hover:underline cursor-pointer">StayEase.org</span></li>
            </ul>
          </div>
        </div>

        {/* Bottom */}
        <div className="mt-10 pt-6 border-t border-gray-300 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            <span>&copy; 2026 StayEase, Inc.</span>
            <span>·</span>
