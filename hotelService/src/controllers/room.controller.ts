...
export async function getAllRoomsHandler(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function getRoomsByHotelHandler(req: Request, res: Response, next: NextFunction) {
  try {
